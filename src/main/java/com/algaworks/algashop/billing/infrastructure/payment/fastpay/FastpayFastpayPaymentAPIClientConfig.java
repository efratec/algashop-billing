...
public class FastpayFastpayPaymentAPIClientConfig {
    ...
    @Bean
    public com.algaworks.algashop.billing.infrastructure.payment.fastpay.FastpayPaymentAPIClient fastpayPaymentAPIClient(
        ...
        return proxyFactory.createClient(com.algaworks.algashop.billing.infrastructure.payment.fastpay.FastpayPaymentAPIClient.class);
    }
